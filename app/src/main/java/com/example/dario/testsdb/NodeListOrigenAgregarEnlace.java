...
public class NodeListOrigenAgregarEnlace extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ListViewNodo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(NodeListOrigenAgregarEnlace.this, "ID ORIGEN:"+ListViewClickData.getIdNode(), Toast.LENGTH_SHORT).show();
